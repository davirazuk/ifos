...
file_permissions=(
  ...
  ["/etc/skel/.config/i3/scripts/nightlight.sh"]="0:0:755"
  ["/etc/skel/.config/i3/scripts/disk-watch.sh"]="0:0:755"
  ["/etc/skel/.config/i3/scripts/screenshot.sh"]="0:0:755"
  ...
  ["/etc/skel/.config/rofi/network-menu.sh"]="0:0:755"
  ["/etc/skel/.config/rofi/bluetooth-menu.sh"]="0:0:755"
  ["/etc/skel/.config/polybar/scripts/media.sh"]="0:0:755"
  ...
  ["/usr/local/bin/ifos-mouse"]="0:0:755"
